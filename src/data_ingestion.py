...
class DataIngestion:
    def __init__(self, config):
        ...
        logger.info(f"Data ingestion started with {self.bucket_name} for file {self.file_name}")
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info(f"Raw CSV file is succesfully downloaded to {RAW_FILE_PATH}")
